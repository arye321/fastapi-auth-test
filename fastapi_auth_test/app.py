...
description = """
fastapi_auth_test API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_auth_test",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_auth_test.com/terms/",
    contact={
        "name": "arye321",
        "url": "http://fastapi_auth_test.com/contact/",
        "email": "arye321@fastapi_auth_test.com",
    },
    license_info={
        "name": "The Unlicense",
