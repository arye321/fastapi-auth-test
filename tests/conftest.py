...
# WARNING: Ensure imports from `fastapi_auth_test` comes after this line
from fastapi_auth_test import app, settings, db  # noqa
from fastapi_auth_test.cli import create_user, cli  # noqa
